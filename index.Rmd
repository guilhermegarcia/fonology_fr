...
#### Université Laval • Centre for Research on Brain, Language & Music
...
- Should we count glides as onsets, codas... nuclei❓ 
...
```{r}
"Aqui está uma frase que desejo transcrever fonemicamente" |> 
  cleanText() |> 
  ipa(narrow = T) |> 
  ipa2tipa(pre = "[ ", post = " ]")
```
